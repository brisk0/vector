...
//Quot returns a vector where b_i = k/a_i.
func (a Vec3d) Quot(k float64) Vec3d {return Vec3d{k/a[0], k/a[1], k/a[2]}}

//Inv returns the multiplicative inverse (reciprocal) of a.
func (a Vec3d) Inv() Vec3d {return a.Quot(1)}
...
func (a Vec3d) Dir() Vec3d {
	abs := a.Abs()
	return Vec3d{a[0] / abs, a[1] / abs, a[2] / abs}
}
